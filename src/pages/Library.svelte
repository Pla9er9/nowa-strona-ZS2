...
<div class="wrapper">
    ...
    <p>Warunkiem przyznania wsparcia było zapewnienie przez organ prowadzący szkołę co najmniej 20% wkładu własnego na realizację zakupów. Otrzymaliśmy wsparcie finansowe dla Biblioteki Szkolnej w kwocie 15.000 złotych, z czego 12.000 pochodzi z dotacji, a 3.000 to wkład własny otrzymany od Powiatu Wągrowieckiego.</p>

    <p>Za przyznaną kwotę zostało zakupionych 567 książek (fantastyka, kryminały, sensacje, horrory, powieści obyczajowe, biografie, książki w języku angielskim itp. oraz lektury, które znajdą się w nowej podstawie programowej), a także 12 audiobooków. Uwzględniono również potrzeby uczniów z niepełnosprawnościami.</p>

    <p>W wyniku realizacji projektu księgozbiór Biblioteki Szkolnej znacznie się wzbogacił. Przy zakupie nowości wydawniczych uwzględniono życzenia uczniów i nauczycieli, a regały z nowymi książkami cieszą się ogromną popularnością wśród czytelników.</p>

    <p>Obok zakupu książek zaplanowano szereg inicjatyw promujących czytelnictwo w szkole oraz w środowisku lokalnym.</p>
...
<div class="wrapper">
    ...
    <p>Objętość naszego katalogu będzie się stale powiększać, ponieważ trwają prace nad  jego  tworzeniem.</p>

    <p>Aby przejrzeć zbiory naszej biblioteki nie musisz się logować. Jeśli chcesz natomiast zamówić lub zarezerwować jakąś książkę musisz założyć sobie konto. W tym celu przyjdź do Biblioteki Szkolnej i podaj swój adres e-mail bibliotekarzowi. Potem skorzystaj z poniższej instrukcji:</p>

    <h2>Instrukcja</h2>

    <p>Możesz też obejrzeć poradnik w formie wideo:</p>
...
<div class="wrapper">
    ...
    <iframe width="603" height="394" src="https://www.youtube.com/embed/QajerwRTGuc" title="Za Siedmioma Półkami S01E02 Hobbit" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

    <iframe width="603" height="394" src="https://www.youtube.com/embed/mgAcRWXym0I" title="Chłopiec w pasiastej piżamie S01E03" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

    <iframe width="603" height="394" src="https://www.youtube.com/embed/eZdCeP3Vo8k" title="Za siemioma półkami S01E04 Elementals" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

    <iframe width="603" height="394" src="https://www.youtube.com/embed/VB-C4ywIWbY" title="Za siedmioma półkami: Zostań, jeśli kochasz" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
